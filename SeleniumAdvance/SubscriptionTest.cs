...
namespace Maveric.SeleniumAdvance
{
    ...
    {
        [Test]
       public static void AddSubscriptionTest()
        {
            ...
            driver.FindElement(By.XPath("//input[@name='demo59703']")).SendKeys("Rakesh");
            driver.FindElement(By.XPath("//input[@id='id2']")).SendKeys("Rout");
            ...
            driver.FindElement(By.XPath("//input[@id='id11']")).SendKeys("8720127592");
